...
class Settings(BaseSettings):
    ...
    DB_USER: Optional[str] = Field(
        default=None, validation_alias=AliasChoices("DB_USER", "DEFECTS_DB_USER")
    )
    DB_PASSWORD: Optional[str] = Field(
        default=None, validation_alias=AliasChoices("DB_PASSWORD", "DEFECTS_DB_PASSWORD")
    )
    DB_HOST: str = Field(
        default="localhost", validation_alias=AliasChoices("DB_HOST", "DEFECTS_DB_HOST")
    )
    DB_PORT: int = Field(
        default=5432, validation_alias=AliasChoices("DB_PORT", "DEFECTS_DB_PORT")
    )
    DB_NAME: Optional[str] = Field(
        default=None, validation_alias=AliasChoices("DB_NAME", "DEFECTS_DB_NAME")
    )
